                ...
                <div className="col-lg-12">
                    <div className="service__main__blk" data-aos="fade-right" data-aos-delay="80" data-aos-duration="1000">
                           ...
                           <p>
                            ...
                            {process.env.NEXT_PUBLIC_BASEURL} (the “EA Website”), related applications, if any
                            ...
                            “Platform”). {process.env.NEXT_PUBLIC_COMPANYNAME}, including its subsidiaries and affiliates
                                ...
                                <h2 className="mt-5">Registration and Eligibility</h2>
                                    ...
                                    <p>We may use your User Submissions in a number of different ways in connection with the
                                     ...
                                     <p>You understand that all information publicly posted or privately transmitted through the
                                        ...
                                        <p>If you see anything inappropriate, please alert us by sending an Email to {process.env.NEXT_PUBLIC_SUPPORTEMAIL}</p>
                                        ...
                                        locations recommended in the region by {process.env.NEXT_PUBLIC_COMPANYNAME} along with a variety of
