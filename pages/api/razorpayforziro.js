 ...
 let addons = req.body.addons && req.body.addons.length > 0 ? req.body.addons.toString() : '';
    ...
    try {
      ...
      let responsedata ={
        ...
        prductdetails: `${nameofpackage} Encamp ZFM 2024 Package`,
        ordertotal:req.body.orderbookingdata.subtotal,
        status:"pending",
        checkindate: '25-09-2024',
        isadvance:isadvance,
        tag: 'Ziro_Festival'
...
let paymentobj = [{ 
                   ...
                   remarks: addons!=='' ? `${nameofpackage} Encamp ZFM 2024 Packag , Add-ons: ` + addons : `${nameofpackage} Encamp ZFM 2024 Package`,
...
let datatosave = {
        ...
        currency: response.currency,
        amount:response.amount,
        prductdetails: addons!=='' ? `${nameofpackage} Encamp ZFM 2024 Package , Add-ons: ` + addons : `${nameofpackage} Encamp ZFM 2024 Package`,
