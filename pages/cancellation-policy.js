...
return(
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="service__main__blk" data-aos="fade-right" data-aos-delay="80" data-aos-duration="1000">
                            ...
                            <h2 className="mt-5">Cancellation and Refund Policy by {process.env.NEXT_PUBLIC_COMPANYNAME}</h2>
                             <div>
                             <h2><br/><br/>1. Cancellation Process</h2>
                              ...
                              <ul>
                                  ...
                                  <li>For any queries and feedback please write an email to <a href={`mailto:${process.env.NEXT_PUBLIC_SUPPORTEMAIL}`}>{process.env.NEXT_PUBLIC_SUPPORTEMAIL}</a></li>
                              </ul>
    ...
    <ul>
         <li>In case of government orders, harsh weather conditions, protests, landslides, or any other unforeseen circumstances, {process.env.NEXT_PUBLIC_COMPANYNAME} will strive to work out the best possible alternate plans or trips/treks.</li>
    ...
    <h2><br/><br/>4. Natural Calamity/Unforeseen Circumstances (Trek or Trip Cancellation)</h2>
       <ul>
         <li>If a trek is called off at the last moment due to a natural calamity or unforeseen circumstances (e.g., rain, snowfall, earthquake, landslides, strike, bandh), {process.env.NEXT_PUBLIC_COMPANYNAME} will issue a trek voucher for the full amount.</li>
    ...
    <p>Before embarking on your adventure with {process.env.NEXT_PUBLIC_COMPANYNAME}, ensure all travel documents, including visas and necessary paperwork, are in order. Please carry a valid ID. Failure to obtain necessary entry permissions may result in the inability to issue a refund. Additionally, possessing a valid motorcycle license and required documentation is mandatory.</p>
    ...
    <p>{process.env.NEXT_PUBLIC_COMPANYNAME}. reserves the right to discontinue services in case of a breach of the rules. 
    </p>
    ...
    <p>Refund requests will be determined by the {process.env.NEXT_PUBLIC_COMPANYNAME}. team, and processing may take up to 15 days. No refunds will be provided for unused services. 
    </p>
    ...
    <p>{process.env.NEXT_PUBLIC_COMPANYNAME}. cannot assume responsibility for accidents, lost luggage, delays, or fines during the tour. 
    </p>
    ...
    <p>{process.env.NEXT_PUBLIC_COMPANYNAME}. initiates the refund within 72 working hours after necessary approvals. Subsequently, it takes 10-14 working days for the credit to become visible in your respective bank accounts.</p>
