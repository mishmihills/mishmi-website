...
if(payment_id && order_id){
    ...
    if(ress.status === 200 || ress.data === 'success' ) {
      ...
      let html = `Dear ${name},`;
      html += "<div>" + `Thank you for choosing ${process.env.NEXT_PUBLIC_BRANDNAME} for your upcoming trip.` + "</div>"; 
      ...
      html += "<div>" + `Should you have any questions or concerns, please do not hesitate to contact us at ${process.env.NEXT_PUBLIC_SUPPORTEMAIL} or  ${process.env.NEXT_PUBLIC_PHONE}` + "</div>";
