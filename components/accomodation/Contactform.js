...
const Contactform = (props) => {
  ...
  const submitAll = async (submitData) => {
    ...
    if (exc.message !== "" || exc.email !== "" || exc.contact !== "" || exc.firstName !== "" || exc.lastName !== "") {
      ...
      const uploaddata = { name: `${submitData.firstName} ${submitData.lastName}`, email: submitData.email, phone: submitData.contact, message: message, tag: 'accomodation', info: submitData };
