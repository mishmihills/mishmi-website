        ...
        <div className="sidebar__main__blk">
          ...
          <form onSubmit={handleSumitForm}>
            ...
            <div className="sidebar__carbon__wrap carbon__wrap2" style={{ backgroundImage: `url('${base_url}/assets/img/carbon_bg.jpg')` }}>
              ...
              {/* <div className="sidebar2__carbon__btn">
                    <a href="#" className="common__btn">Learn More About Carbon Stuff</a>
                </div>*/}
            </div>
            <Coupon appliedCoupon={appliedCoupon} setAppliedCoupon={setAppliedCoupon} payableamount={totalprice?.[3] ?? 0} applicableCategory={['itinerary']} reseter={reseter} setReseter={setReseter}/>
            {ispartialx && (
              <>
