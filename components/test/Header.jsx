    ...
    <header className="sticky-top bg-light shadow">
      <div className="container-fluid py-3 d-flex align-items-center justify-content-between px-4">
        <Link href="/" legacyBehavior>
          <a className="d-flex align-items-center text-decoration-none">
            <span className="h4 font-serif text-success fw-bold">Mishmi Hills</span>
          </a>
        </Link>
        
        {/* Desktop Menu */}
        <nav className="d-none d-md-flex gap-5">
          <Link href="#itinerary" passHref legacyBehavior>
            <a className="text-dark text-decoration-none hover:text-muted">Itinerary</a>
          </Link>
          <Link href="#accommodations" passHref legacyBehavior>
            <a className="text-dark text-decoration-none hover:text-muted">Accommodations</a>
          </Link>
          <Link href="#sustainable-travel" passHref legacyBehavior>
            <a className="text-dark text-decoration-none hover:text-muted">Sustainable Travel</a>
          </Link>
      ...
      <div className={`sidebar bg-light ${isNavOpen ? 'sidebar-open' : ''}`}>
        ...
        <nav className="d-flex flex-column align-items-start p-3">
          ...
          <Link href="#sustainable-travel" passHref legacyBehavior>
            <a className="d-block py-2 text-dark text-decoration-none hover:text-muted" onClick={toggleNav}>Sustainable Travel</a>
          </Link>
          <Link href="#about" passHref legacyBehavior>
