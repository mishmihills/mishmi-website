...
const {AOS,nameite,successpage,setSuccesspage,sendMail,Tagmanageri} = props;
...
const uploaddata = {name:`${firstname} ${lastname}`,email:submitData.email,phone:submitData.contact,message:message,tag:'destination-enquiry',info:submitData};
