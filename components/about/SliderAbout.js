                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="about__hero__content" data-aos="fade-up" data-aos-delay="50"
                            ...
                            <h2>{process.env.NEXT_PUBLIC_BRANDNAME}</h2>
                        ...
                        <div className="about__hero__content2" data-aos="fade-up" data-aos-delay="50"
                            data-aos-duration="1000">
                            <p>We at {process.env.NEXT_PUBLIC_BRANDNAME}, celebrate natures uniqueness by giving you an adventure, specially catered to not just have to visit the place but experience a journey.</p>
                        </div>
                    </div>
                </div>
            </div>
